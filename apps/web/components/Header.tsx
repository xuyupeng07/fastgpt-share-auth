        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <h1 className="text-xl font-bold text-foreground">FastGPT</h1>
              <p className="text-xs text-muted-foreground hidden sm:block">工作流分享平台</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="hidden sm:flex items-center gap-2 px-3 py-1.5 text-sm bg-muted hover:bg-muted/80 rounded-md transition-colors text-muted-foreground hover:text-foreground"
            >
